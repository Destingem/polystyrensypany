      ...
      >
        ...
        <List sx={device !== "laptop" ? {}: {textAlign: "left", color: "#545454", fontWeight: "400"} } icon={<Space h={0} />}>
          <ListItem>
            <Link href="/images/certifikat.pdf">
              <Text class="link" component="p">Protokol o zkoušce tepelné vodivosti - 3 strany</Text>
            </Link>
          </ListItem>
          <ListItem>
            <Link href="/images/Protokol_o_zkousce.pdf">
              <Text class="link" component="p">Protokol o zkoušce objemové hmotnosti a vlhkosti - 3 strany</Text>
            </Link>
          </ListItem>
          <ListItem>
            <Link href="/images/Prohlaseni_o_vlastnostech.pdf">
              <Text class="link" component="p">Prohlášení o vlastnostech</Text>
            </Link>
          </ListItem>
          <ListItem>
            <Link href="/images/tech_list.pdf">
              <Text class="link" component="p">Technický list - Polystyren sypaný</Text>
            </Link>
          </ListItem>
        </List>
        ...
        <ListItem sx={device !== "laptop" ? {}: {textAlign: "left", color: "#545454", fontWeight: "400"} } icon={<Space h={0} />}>
          <Link href="/images/certifikat_proverena_spolecnost.pdf">
            <Text class="link" component="p">Certifikát - Prověřená společnost</Text>
          </Link>
        </ListItem>
        <Space h={3} />
      </div>
