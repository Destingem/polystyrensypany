    ...
    >
      ...
      >
       ...
       <Heading device={device}>
        ...
        </Text><Space h="xl" /><Image src="http://134.122.88.214:1337/uploads/risa_9b8675dba1.webp?width=1920&height=1440" width={4} height={3} layout="responsive" /></>  :<> <Text size="xl" weight={500} sx={{ color: "#545454", fontSize: device ==! "laptop" ? "8vw" : "3rem", textAlign: device === "laptop" ? "left" : "center", margin: "0"  }} component="h2">
          Jak to všechno začalo
       ...
       <div style={{width: "30%"}}> <Image src="http://134.122.88.214:1337/uploads/risa_9b8675dba1.webp?width=1920&height=1440" width={4} height={3} layout="responsive" /></div>
        </div></>}
      </section>
      <section  style={{
