    ...
    return (
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: "3vh 5vw 3vh 5vw", gap: "3vh"}}>
          ...
          sx={{ textAlign: "left" }}>
            ...
            {device == "mobile" ? <><Image src="/images/barevny.png" alt="Polystyren sypaný XPS" layout="responsive" width={4} height={3} sx={{ width: "100%", height: "auto", marginRight: "auto", marginLeft: "auto", textAlign: "center" }} />
            <Image src="/images/XPS2.jpg" alt="Polystyren sypaný XPS"  layout="responsive" width={299} height={448} sx={{ width: "100%", height: "auto", marginRight: "auto", marginLeft: "auto", textAlign: "center" }} /></>
            : <Grid justify="center">
            <Grid.Col span={6} sx={{maxWidth: "25% !important", justifyContent: "center", marginTop: "auto", marginBottom: "auto"}}>
            <Image src="/images/XPS2.jpg" alt="Polystyren sypaný XPS" layout="responsive" width={4} height={3} sx={{ width: "100%", height: "auto", marginRight: "auto", marginLeft: "auto", textAlign: "center" }} />
           
            </Grid.Col>
            <Grid.Col span={6} sx={{maxWidth: "20% !important"}}>
            <Image src="/images/XPS_pytel.png" alt="Pytel polystyren sypaný XPS" layout="responsive" width={299} height={448} sx={{ width: "100%", height: "auto", marginRight: "auto", marginLeft: "auto", textAlign: "center" }} />
            </Grid.Col>
            <Grid.Col span={6} sx={{maxWidth: "25% !important", justifyContent: "center", marginTop: "auto", marginBottom: "auto"}}>
            <Image src="/images/pytle_xps.jpg" alt="Pytel polystyren sypaný XPS" layout="responsive" width={4} height={3} sx={{ width: "100%", height: "auto", marginRight: "auto", marginLeft: "auto", textAlign: "center" }} />
            </Grid.Col>
