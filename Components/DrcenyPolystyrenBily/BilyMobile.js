    ...
    return (
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: "3vh 5vw 3vh 5vw", gap: "3vh"}}>
          ...
          sx={{ textAlign: "left" }}>
           ...
           <Link href="/ceny#polystyren-sypany-EPS-bily"><Button variant="gradient" gradient={{from: "teal", to: "lime"}} size="lg" sx={{ width: device !== "laptop" ? "100%" : "20%" , marginTop: "3vh", marginLeft: "auto" }}>Ceník pro EPS polystyren bílý</Button></Link>
